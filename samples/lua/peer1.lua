...
To run this script execute: tgdp @peer1.lua
Add flag '-v 3' to increase verbosity level and see coomon messages: tgdp -v 3 @peer1.lua
]]

local d = require("diameter")

local peer, err = d.peer.new("DEMO", "localhost", 3868, "tcp")
if err ~= nil then
  print(err)
  return
end
